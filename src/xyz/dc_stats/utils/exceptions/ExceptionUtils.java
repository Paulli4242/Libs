...
public final class ExceptionUtils {
    ...
    public static <T> T getIE(ExceptionalSupplier<T> getter){
        return getter.ignoreException();
    }
    public static <T> T getIE(ExceptionalSupplier<T> getter, T def){
    ...
    public static <T> T getAsRE(ExceptionalSupplier<T> getter){
        return getter.asRuntimeException();
    }
    public static void runAsRE(ExceptionalRunnable run){
        run.asRuntimeException();
    }
    public static <T> T getAsRE(ExceptionalSupplier<T> getter, Class<?extends RuntimeException> ex){
